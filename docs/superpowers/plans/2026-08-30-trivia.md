...
set local request.jwt.claims to '{"sub":"00000000-0000-4000-8000-0000000000c1"}';
...
-- ------------------------------------------------------- as the ADMIN ------
set local request.jwt.claims to '{"sub":"00000000-0000-4000-8000-0000000000c2"}';
...
Run: `psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f supabase/tests/trivia.sql`
Expected: only `PASS:` notices, ending in `ROLLBACK`. Seven PASS lines.
