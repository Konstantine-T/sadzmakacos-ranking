...
export const ka = {
  ...
  vote: {
    ...
    secret: 'ვინ ვის აძლევს ხმას — საიდუმლოა',
  },
  ...
  comments: {
    ...
    locked: 'კვირა დასრულდა, კომენტარები დაკეტილია',
    deleted: 'წაშლილია',
  ...
  profile: {
    ...
    badges: 'ჯილდოები',
    weeksAtOne: 'კვირა პირველ ადგილზე',
...
export function errorToKa(message: string | undefined): string {
  ...
  if (message.includes('forbidden') || message.includes('not_a_member')) return ka.errors.forbidden;
