...
export const ka = {
  ...
  standings: {
    ...
    /* The final six hours: standings withheld, voting unchanged. */
    hiddenLabel: "ადგილი დამალულია",
    blackout:
      "ამ მომენტში, რანკის ადგილები არ ჩანს ყველასთვის, თუმცა ხმის მიცემა ჩვეულებრივ გრძელდება. კვირის დასრულებისას, ყველაფერი ადეკვატურად გამოჩნდება",
    new: "ახალი",
  ...
  push: {
    title: "შეტყობინებები",
    why: "მიიღებ შეტყობინებას რანკის ცვლილებაზე, პოსტებზე, ჩატსა და ტრივიაზე",
    enable: "ჩართვა",
    enabled: "ჩართულია",
    blocked: "ბრაუზერში აკრძალულია — ჩართე პარამეტრებიდან",
    needsInstall: "ჯერ დააყენე აპლიკაციასავით (იხილე ზემოთ)",
    unsupported: "ამ ბრაუზერს არ აქვს მხარდაჭერა",
  },
  ...
  survival: {
    name: "ქვიზი",
    subtitle: "ქულები სურვაივალის სტილით",
    start: "თამაშის დაწყება",
    again: "თავიდან",
    pickCategory: "კატეგორია",
    boards: "საუკეთესო შედეგები",
    fullBoard: "სრულად",
    empty: "ჯერ არავის უთამაშია",
    streak: "ზედიზედ",
    best: "რეკორდი",
    ...
    close: "დახურვა",
    credit: "კითხვები: The Trivia API · CC BY-NC 4.0",
    difficulty: {
      easy: "მარტივი",
      medium: "საშუალო",
      hard: "რთული",
    ...
    categories: {
      all: "ყველა",
      general_knowledge: "ზოგადი ცოდნა",
      geography: "გეოგრაფია",
      history: "ისტორია",
      science: "მეცნიერება",
      film_and_tv: "კინო და ტელევიზია",
      music: "მუსიკა",
      sport_and_leisure: "სპორტი და გართობა",
      food_and_drink: "საკვები და სასმელი",
      arts_and_literature: "ხელოვნება და ლიტერატურა",
      society_and_culture: "საზოგადოება და კულტურა",
    },
  },
